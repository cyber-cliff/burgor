...
const Thinkerist  = () => {
  ...
  const [target] = useState(new THREE.Vector3(-0.5, 8, 0))
  ...
  useEffect(() => {
    ...
    if (container && !renderer) {
      ...
      // axesHelper.setColors(new THREE.Color(0xeb4034), new THREE.Color('blue'), new THREE.Color('yellow'))
      ...
      loadGLTFModel(scene, 'burgor.glb', {
        receiveShadow: true,
        castShadow: true
      }).then(() => {
        animate()
